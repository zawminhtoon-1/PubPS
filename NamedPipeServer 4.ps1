...
"@
    ...
    $clientCounter = [long[]](0L)   # shared atomic counter — passed by reference to all runspaces
    ...
    try {
        while ($true) {
            ...
            # Atomically increment shared counter — thread-safe ClientID
            $ClientID = [System.Threading.Interlocked]::Increment([ref]$clientCounter[0])
